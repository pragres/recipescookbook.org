...
/**
 * Ramifip MySQl Database Driver
 * 
 * @version 1.0
 * @link http://ramifip.com
 */

u("ramifip/modules/rpDBDriver/rpDBDriver");
...
class rpDBDriverMySQL extends rpDBDriver {
	...
	public function Connect() {
		if (!function_exists("mysql_connect")) {
			throw new rpException("The MySQL extension for PHP is not enabled. May be you are using differents php.ini files.");
		}
