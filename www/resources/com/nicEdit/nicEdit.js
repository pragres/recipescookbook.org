...
var nicEditors = {
    ...
    allTextAreas : function(nicOptions) {
        if(typeof(nicOptions) == "undefined")
            nicOptions = {};
        var textareas = document.getElementsByTagName("textarea");
        for(var i=0;i<textareas.length;i++) {
            nicOptions.id = textareas[i].id;
            if (document.getElementById("editor-" + nicOptions.id) == null)
...
var nicEditor = bkClass.extend({
    ...
    getIcon : function(iconName,options) {
        ...
        return {
            backgroundImage : "url('img.php?f=com/nicEdit/"+((icon) ? this.options.iconsPath : file)+"')",
